        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="{{ route('user.deleted') }}" class="btn btn-light">
                    ...
                    <div class="card-body">
                        ...
                        @if ($user->profile)
                            <div class="d-grid gap-2 mt-4">
                                <form action="{{ route('user.users.update', $user->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('PUT')
                                ...
                                <button type="button" class="btn btn-danger d-inline" data-toggle="modal" data-target="#confirmDelete" title="{{ trans('tooltips.permanentlyDelete') }}">
