                            ...
                            <tbody>
                                ...
                                @foreach ($users as $user)
                                    <tr>
                                        ...
                                        <td>
                                            {!! Form::model($user, [
                                                'action' => ['Admin\SoftDeletesController@update', $user->id],
                                                'method' => 'PUT',
                                                'data-toggle' => 'tooltip',
                                            ]) !!}
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-info btn-block"
                                                href="{{ URL::to('admin/deleted-users/' . $user->id) }}" data-toggle="tooltip"
                                                title="Show User">
                                        ...
                                        <td>
                                            {!! Form::model($user, [
                                                'action' => ['Admin\SoftDeletesController@destroy', $user->id],
                                                'method' => 'DELETE',
                                                'class' => 'inline',
                                                'data-toggle' => 'tooltip',
