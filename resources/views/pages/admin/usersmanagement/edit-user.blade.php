        ...
        <div class="card shadow-lg border-0 rounded-lg">
            ...
            <div class="card-body p-4">
                ...
                <form class="needs-validation" role="form" method="POST"
                    action="{{ route('admin.users.update', $user->id) }}" novalidate>
                    @csrf
                    @method('PUT')
                            ...
                            <div class="form-group mb-3 {{ $errors->has('name') ? 'has-error' : '' }}">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-lg" id="name" name="name"
                                        value="{{ old('name', $user->name) }}" placeholder="{!! trans('forms.create_user_ph_username') !!}"
                                        required>
                            ...
                            <div class="form-group mb-3 {{ $errors->has('email') ? 'has-error' : '' }}">
                                ...
                                <div class="input-group">
                                    <input type="email" class="form-control form-control-lg" id="email" name="email"
                                        value="{{ old('email', $user->email) }}" placeholder="{!! trans('forms.create_user_ph_email') !!}"
                                        required>
                                    <span class="input-group-text bg-light">
