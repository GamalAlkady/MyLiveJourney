    ...
    <div class="col-lg-12">
        <div class="card mt-5">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    <div class="card-title d-flex align-items-center">
                     ...
                     <div class="float-right">
                        <a href="{{ route('admin.tour.index') }}" class="btn btn-outline-primary btn-sm float-right"
            ...
            <div class="card-body p-4">
                <form action="{{ $isEdit ? route('admin.tour.update', $tour->id) : route('admin.tour.store') }}"
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group">
                                    <input type="date" value="{{ old('date', $isEdit ? $tour->date : date('Y-m-d')) }}"
                                        class="form-control" placeholder="{{ trans('forms.enter_date') }}" id="date"
                                        name="date" required>
                                </div>
                                @if ($errors->has('date'))
                                    <div class="invalid-feedback d-block">
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group">
                                    <input type="number" min="1" value="{{ old('day', $isEdit ? $tour->day : 1) }}"
                                        class="form-control" placeholder="{{ trans('forms.enter_day') }}" id="day"
                                        name="day" required>
                                </div>
                                @if ($errors->has('day'))
                                    <div class="invalid-feedback d-block">
