            ...
            <div class="col-md-12">
                ...
                <div class="card my-5 mx-4">
                    <div class="card-header  bg-dark">
                      <h3 class="card-title float-left p-0 m-0"><strong>Manage Guides ({{ $guides->count() }})</strong></h3>
                    </div>
                    <!-- card-header -->
                    @if ($guides->count() > 0)
                    <div class="card-body">
                    <div class="table-responsive">
                      <table id="dataTableId" class="table table-bordered table-striped">
                        ...
                        <tbody>
                        @foreach ($guides as $key=>$user)
                        <tr>
                          <td>{{ $user->name }}</td>
                          <td>{{ $user->email }}</td>
                          <td>{{ $user->contact }}</td>
                         <td><img height="70" width="70" src="{{  $user->image != null ?  asset('storage/profile_photo/' . $user->image ) :  asset('assets/admin/img/user2-160x160.jpg')  }}" alt="photo"></td>
                  ...
                  <div class="modal-dialog">
                      <form action="" id="changeRoleForm" method="POST">
                          ...
                          @method('PUT')
                             ...
                             itle" id="exampleModalLabel">Manage Admins</h5>
