        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card my-5 mx-4">
                    ...
                    <a href="{{route('user.guide.create')}}" class="btn btn-success btn-md float-right c-white">Add New <i class="fa fa-plus"></i></a>
                    </div>
                    <!-- card-header -->
                    @if ($guides->count() > 0)
                    <div class="card-body">
                      ...
                      <table id="dataTableId" class="table table-bordered table-striped">
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="{{ route('user.guide.edit', $guide->id) }}" class="btn btn-info">Edit</a>
