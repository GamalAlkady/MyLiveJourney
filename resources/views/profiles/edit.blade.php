                            ...
                            <div class="row">
                                <div class="col-12 col-sm-4 col-md-3 text-white ">
                                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                        ...
                                        <a class="nav-link" data-toggle="pill" href=".edit-settings-tab" role="tab"
                                            ...
                                            <div
                                                ...
                                                <div class="col-12">
                                                    <div class="input-group">
                                                        <select class="custom-select form-control" name="theme_id"
                                                            id="theme_id">
                                                            @if ($themes->count())
                                                        ...
                                                        <div class="col-sm-6 offset-sm-3 margin-bottom-3 text-center">
                                                            ...
                                                            <div class="btn-group btn-group-vertical margin-bottom-2 custom-checkbox-fa"
                                                                ...
                                                                <label class="btn no-shadow" for="checkConfirmDelete">
                                                                    ...
                                                                    <span class="margin-left-2"> Confirm Account
                                                                        Deletion</span>
                                                                </label>
                                                            </div>
