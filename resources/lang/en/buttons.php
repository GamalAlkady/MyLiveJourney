...
return [
    ...
    */
    'empty' => 'Empty',
    'switch_to_virtual' => 'Switch to virtual reality',
    ...
    // User Buttons
    'create_user' => '<i class="fa fa-user-plus fa-fw" aria-hidden="true"></i> <span class="hidden-xs">Create New</span><span class="hidden-xs"> User</span>',
    ...
    'icon' => [
        'text' => [
            'empty' => '<i class="fa fa-trash-alt fa-fw" aria-hidden="true"></i> <span class="hidden-xs">Empty</span>',
        ],
    ],
];
