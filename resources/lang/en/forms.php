...
return [
    ...
    */
    ...
    'district' => '<i class="fas fa-map-marker-alt me-1"></i> District',
    'enter_district' => 'Enter :district Name',
    'placetype' => '<i class="fas fa-tags  me-1"></i> Place Type',
    'description' => '<i class="fas fa-info-circle me-1"></i> Description',
    'enter_description' => 'Enter Description',
    'image' => '<i class="fas fa-image me-1"></i> Image',
    'choose_image' => 'Choose image file...',
    'address' => '<i class="fas fa-map-marker-alt me-1"></i> Address',
    'enter_address' => 'Enter Address',
    'phone' => '<i class="fas fa-phone-alt me-1"></i> Phone',
    'enter_phone' => 'Enter Phone',
    'email' => '<i class="fas fa-envelope me-1"></i> Email',
    'enter_email' => 'Enter Email',
    'price' => '<i class="fas fa-money-bill-wave me-1"></i> Price',
    'enter_price' => 'Enter Price',
    'people' => '<i class="fas fa-users me-1"></i> People',
    'enter_people' => 'Enter Number of People',
    'date' => '<i class="fas fa-calendar-alt me-1"></i> Date',
    'enter_date' => 'Enter Date',
    'days' => '<i class="fas fa-calendar-day me-1"></i> Days',
    'enter_day' => 'Enter Number of Days',
