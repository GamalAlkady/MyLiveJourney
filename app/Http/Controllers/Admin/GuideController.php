...
class GuideController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.admin.guide.index',compact('guides', 'guideCount'));
    }
    ...
    public function create()
    {
         ...
         return view('pages.admin.guide.create');
    }
    ...
    public function show(Guide $guide)
    {
      ...
      return view('pages.admin.guide.show',compact('guide'));
    ...
    public function edit(Guide $guide)
    {
         ...
         return view('pages.admin.guide.edit',compact('guide',$guide));
    }
