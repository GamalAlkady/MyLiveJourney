...
class UsersManagementController extends Controller
{
    ...
    public function index()
    {
        ...
        return View('pages.admin.usersmanagement.show-users', compact('users'));
    }
    ...
    {
        return view('pages.admin.usersmanagement.show-user', compact('user'));
    }
    ...
    public function edit(User $user)
    {
        ...
        return view('pages.admin.usersmanagement.edit-user')->with($data);
    }
